...
const subCategories: SubCategories = {
  ...
  Yumurta: [
    { id: 1, name: 'Köy Yumurtası' },
    { id: 2, name: 'Organik Yumurta' },
    { id: 3, name: 'Tavuk Yumurtası' },
  ],
  Bal: [
    { id: 1, name: 'Çiçek Balı' },
    { id: 2, name: 'Süzme Bal' },
    { id: 3, name: 'Karakovan Balı' },
  ],
  Tohum: [
    { id: 1, name: 'Ayçiçeği Tohumu' },
    { id: 2, name: 'Kabak Tohumu' },
    { id: 3, name: 'Keten Tohumu' },
  ],
  'Süt Ürünleri': [
    { id: 1, name: 'Süt' },
    { id: 2, name: 'Yoğurt' },
...
const Products = ({ navigation }: ProductsProps) => {
  ...
  const [products, setProducts] = useState<Product[]>([
    ...
    // Sebze Kategorisi
    {
      ...
      name: 'Salatalık',
      price: 10,
      image: 'https://example.com/salatali.jpg',
    ...
    },
    {
      ...
      name: 'Patlıcan',
      price: 15,
      image: 'https://example.com/patlican.jpg',
    ...
    // Diğer kategoriler için benzer şekilde ürünler eklenebilir
  ]);
  ...
  React.useEffect(() => {
    // Seçilen ana kategori ve alt kategoriye göre ürünleri filtrele
    const filteredProducts = originalProducts.filter(product => 
      product.category === selectedMainCategory && 
      product.subCategory === selectedSubCategory
    );
    setProducts(filteredProducts);
  }, [selectedMainCategory, selectedSubCategory, originalProducts]);
